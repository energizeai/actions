  ...
  plop.setGenerator("action-starter", {
    ...
    actions: [
      ...
      },
      {
        ...
        templateFile: "templates/type/{{lowerCase type}}/output.hbs",
      },
      {
        type: "modify",
        path: "src/{{dashCase name}}.tsx",
        pattern: /<\|CARD_COMPONENT_TEMPLATE\|>/,
        templateFile: "templates/type/{{lowerCase type}}/component.hbs",
      },
      {
        type: "modify",
        path: "src/{{dashCase name}}.tsx",
        pattern: /<\|RETURN_TEMPLATE\|>/,
        templateFile: "templates/type/{{lowerCase type}}/return.hbs",
      },
      {
        type: "modify",
        path: "src/{{dashCase name}}.tsx",
        pattern: /<\|AUTH_TEMPLATE\|>/,
        templateFile: "templates/auth/{{lowerCase auth}}/auth.hbs",
      },
      {
        type: "modify",
        path: "src/{{dashCase name}}.tsx",
        pattern: /<\|SCOPE_POOL_TEMPLATE\|>/,
        templateFile: "templates/auth/{{lowerCase auth}}/scope-pool.hbs",
      },
      {
        type: "modify",
        path: "src/index.tsx",
      ...
      },
      {
        ...
        template: `'{{properCase name}}': {{properCase name}}Action,\n  // <|GENERATOR|> add new action here`,
      },
    ],
  })
}
