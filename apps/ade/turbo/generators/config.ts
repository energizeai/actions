  ...
  plop.setGenerator("action-starter", {
    ...
    prompts: [
      ...
      },
      {
        type: "input",
        name: "name",
        message: "What is the name of the action? (e.g. `Web Search`)",
    ...
    actions: [
      {
        type: "add",
        path: "registry/{{ camelCase resource }}-{{camelCase name}}.tsx",
      ...
      },
      {
        ...
        template: `import { {{properCase name}}Action } from './{{ camelCase resource }}-{{camelCase name}}';\n// <|GENERATOR|> import new action here`,
      },
      {
        type: "modify",
        path: "registry/index.ts",
